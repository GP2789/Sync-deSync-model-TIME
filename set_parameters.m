...
%% SET PARAMETER SPACE FUNCTION
    ...
    parameter_settings = ...
        ...
        'EC_modulation', false, 'EC_W', 0.3, 'rand_EC_phase', false,...
        ...
        'theta_LTD', false, 'theta_mod', false, 'STDP_th', true, 'STDP_hetero', false ...
        ...
        'stim_mod', true, 'stim_range', true, 'stim_F', 4, 'stim_G1_ph', 270, 'stim_G2_ph', 180, ... % for oscillatory modulation
