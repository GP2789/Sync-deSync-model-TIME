...
%% SET PARAMETER SPACE FUNCTION
    ...
    parameter_settings = ...
        ...
        'stim_mod', true, 'stim_F', 4, 'stim_G1_ph', 270, 'stim_G2_ph', 180, ... % for oscillatory modulation
        'stim_n', 0, 'burst_n', [], 'stimulus_strength', 2}; % for strength & timing DC input (or burst)
    ...
    par.sim_order = { 'learning', 'NP presentation', 'P presentation', 'idling'}; 
